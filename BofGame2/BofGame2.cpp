...
private:
    ...
    void init()
    {
        ...
        }
        {
            ...
            BOF_ASSERT(availableFeatures.samplerAnisotropy);
            enabledFeatures.samplerAnisotropy = VK_TRUE;

            BOF_ASSERT(availableFeatures.fillModeNonSolid);
            enabledFeatures.fillModeNonSolid = VK_TRUE;

            BOF_ASSERT(availableFeatures.wideLines);
...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    {
        std::shared_ptr<Allo> b;

        {
            auto a = std::make_shared<Allo>();
    ...
    std::string s = grid.ToJsonString();
    cout << s << endl;

    {
        ComponentGrid gridFromString;
        prepareMyGridWithComponentVectors(gridFromString);

        grid.FromJsonString(s);

        cout << grid.GetCompIfExists<Allo>(myEntity0)->ToJsonString() << endl;
    }




    auto app = std::make_unique<BofGame>();
